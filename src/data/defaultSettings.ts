...
export const DEFAULT_SITE_SETTINGS: SiteSettings = {
  ...
  metaKeywords:
    'BPO India, Call Center Services, Customer Support Outsourcing, Contact Center India, Business Process Outsourcing, Basco Group, Inbound Call Center, Technical Support, CX Outsourcing',
